...
class DataLoader:
    def __init__(
        self, dataset_name="K_test", test=False, shuffle=False, normalize=True
    ):
    ...
    def create(self):
        ...
        self.def_vel = self.normalize(
            "dev_vel", np.asarray(self.body_vel - self.tire_vel)
        )
    ...
    def read(self, window_size):
        ...
        np.savez(
            "./datasets/" + self.dataset_name + "_" + str(window_size) + ".npz",
